...
const challengesData = [
  ...
  },
  {
    id: 3,
    category: 'Energie',
    icon: <FaPlug className="text-greenLight w-8 h-8" />,
  ...
  },
  {
    ...
    icon: <FaShoppingBag className="text-greenLight w-8 h-8" />,
  ...
  },
  {
    ...
    icon: <FaSolarPanel className="text-greenLight w-8 h-8" />,
        ...
        {challenges.map((challenge) => (
          ...
          >
            ...
            <div className="ml-5 w-3/4">
              ...
              <p className="text-sm mb-2">Schwierigkeit: {challenge.difficulty}</p>
              <button
                onClick={(e) => {
                  e.stopPropagation();
      ...
      {selectedChallenge && (
        ...
        >
          <div className="bg-dark p-5 rounded-lg text-cream relative">
            ...
            <p className="mb-4">Schwierigkeit: {selectedChallenge.difficulty}</p>
            <button
              onClick={() => {
